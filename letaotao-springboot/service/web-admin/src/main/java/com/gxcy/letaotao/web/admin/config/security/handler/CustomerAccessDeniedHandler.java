...
public class CustomerAccessDeniedHandler implements AccessDeniedHandler {
    ...
    private static final Integer ERR_CODE = BizExceptionEnum.USER_NOT_PERMISSION.getCode();
    private static final String ERR_MESSAGE = BizExceptionEnum.USER_NOT_PERMISSION.getMsg();
